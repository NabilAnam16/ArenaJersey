...
module.exports = async (req, res) => {
    ...
    try {
        ...
        // Server Key Midtrans (ganti dengan Server Key milikmu dari dashboard Midtrans)
        // Format: SB-Mid-server-xxxxxxxx (untuk Sandbox/uji coba)
        ...
        const transactionData = {
            ...
            item_details: items,
            callbacks: {
                finish: `${req.headers.origin || 'https://arenajersey.vercel.app'}/success.html`
            }
        };
